...
return {
    ...
    text = {},
    fields = {
        { t = "Band",    x = 25,  y = 14, sp = 50, min=1, max=5, vals = { 2 }, to = SMLSIZE, persist = true, table = { "A", "B", "E", "F", "R" }, upd = function(self) self.updateVTXFreq(self) end },
        { t = "Channel", x = 25,  y = 24, sp = 50, min=1, max=8, vals = { 3 }, to = SMLSIZE, persist = true, upd =  function(self) self.updateVTXFreq(self) end },
        { t = "Power",   x = 25,  y = 34, sp = 50, min=1, vals = { 4 }, to = SMLSIZE, persist = true, upd = function(self) self.updatePowerTable(self) end },
